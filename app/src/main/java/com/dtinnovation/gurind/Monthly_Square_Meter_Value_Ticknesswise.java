...
public class Monthly_Square_Meter_Value_Ticknesswise extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_montly_quaremeter_value_ticknesswise, container, false);
        hiChartView = view.findViewById(R.id.MSVThickness);
        ...
        title_MSV.setText("Monthly Thickness Wise Square Meter");
        ...
        yTitle.setText("Square Meter (Thickness Wise)");
        hiyAxis.setTitle(yTitle);

        final HIColumn MSDataColumn = new HIColumn();
        MSDataColumn.setName("Monthly Thickness Wise Square Meter");
        ...
        if (netInfo == null){
            ...
            try {
                ...
                String url = "http://220.247.238.246/gurind/mobile_API/monthly_thickness_sqm.php";
