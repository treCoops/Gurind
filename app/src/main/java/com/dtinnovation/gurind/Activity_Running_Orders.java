...
public class Activity_Running_Orders extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.activity_running_orders, container, false);
        ...
        final TableLayout tableLayout = view.findViewById(R.id.tableLayout_CO);
        ...
        if (netInfo == null){
            ...
            try {
                ...
                String url = "http://220.247.238.246/gurind/mobile_API/confirm_orders.php";
                            ...
                            if(response.getInt("status") == 200){
                                ...
                                for(int i=0; i<jsonArray.length(); i++){
                                    ...
                                    if(i % 2 == 0){
                                        ...
                                        t4.setText(data.getString("TOTAL_DISPATCHED"));
                                        ...
                                        t5.setText(data.getString("READY_QTY"));
                                        ...
                                        t6.setText(data.getString("BALANCE_TO_PRODUCE"));
                                        ...
                                        TextView t7 = new TextView(view.getContext());
                                        t7.setLayoutParams(new TableRow.LayoutParams(TableRow.LayoutParams.WRAP_CONTENT, TableRow.LayoutParams.MATCH_PARENT));
                                        t7.setText(data.getString("COMPLETED_PERCENTAGE")+"%");
                                        t7.setTextColor(Color.parseColor("#000000"));
                                        t7.setBackground(view.getResources().getDrawable(R.drawable.table_body2));
                                        t7.setTextSize(15);
                                        t7.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
                                        t7.setPadding(15,3, 15, 3);
                                        tr.addView(t7);
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Running Orders");
    }
