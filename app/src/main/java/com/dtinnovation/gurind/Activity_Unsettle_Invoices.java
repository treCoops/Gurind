...
public class Activity_Unsettle_Invoices extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        final View view = inflater.inflate(R.layout.activity_unsettle_invoices, container, false);
        ...
        final TableLayout tableLayout = view.findViewById(R.id.tableLayout_ui);
        ...
        if (netInfo == null){
            ...
            try {
                ...
                String url = "http://220.247.238.246/gurind/mobile_API/bad_debtors.php";
                        ...
                        try{
                            ...
                            if(response.getInt("status") == 200){
                                ...
                                for(int i=0; i<jsonArray.length(); i++){
                                    ...
                                    total_value = total_value + data.getDouble("BALANCED_TO_PAY");
                                    ...
                                    if(i % 2 == 0){
                                        ...
                                        t1.setText(data.getString("INVOICE_NO"));
                                        ...
                                        t2.setText(data.getString("INVOICE_DATE"));
                                        ...
                                        t3.setText(data.getString("PROJECT_REFERENCE"));
                                        ...
                                        t4.setText(convertTOCurrency(data.getString("BALANCED_TO_PAY")));
...
//                                        t4.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
                                        ...
                                        t5.setText(data.getString("OUTSTANDING_DATES"));
...
//                                        t4.setTextAlignment(View.TEXT_ALIGNMENT_CENTER);
                                ...
                                t6.setText(convertTOCurrency(String.valueOf(total_value)));
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Unsettle Invoices");
    }
