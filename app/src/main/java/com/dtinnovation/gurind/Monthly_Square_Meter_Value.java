...
public class Monthly_Square_Meter_Value extends Fragment {
    ...
    public View onCreateView(@NonNull LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        View view = inflater.inflate(R.layout.activity_monthly_square_meter_value, container, false);
        hiChartView = view.findViewById(R.id.MSMValue);
        ...
        title_MSV.setText("Monthly Square Meter");
        ...
        yTitle.setText("Monthly Square Meter");
        hiyAxis.setTitle(yTitle);

        final HIColumn MSDataColumn = new HIColumn();
        MSDataColumn.setName("Monthly Square Meter");
        ...
        if (netInfo == null){
            ...
            try {
                ...
                String url = "http://220.247.238.246/gurind/mobile_API/monthly_sqm_value.php";
