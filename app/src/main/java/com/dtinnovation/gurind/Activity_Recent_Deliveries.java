...
public class Activity_Recent_Deliveries extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.activity_recent_deliveries, container, false);
        ...
        if (netInfo == null){
            ...
            try {
                ...
                String url = "http://220.247.238.246/gurind/mobile_API/recently_delivery.php";
                            ...
                            if(response.getInt("status") == 200){
                                ...
                                for(int i=0; i<jsonArray.length(); i++){
                                    ...
                                    if(i % 2 == 0){
                                        ...
                                        t1.setText(data.getString("DISPATCH_NO"));
                                        ...
                                        t2.setText(data.getString("QUOTATION_NO"));
                                        ...
                                        t4.setText(data.getString("TOTAL_DISPATCHED_QTY"));
                                        ...
                                        t5.setText(data.getString("DISPATCH_DATE"));
                                        ...
                                        t6.setText(data.getString("DRIVER_NAME")+"/"+data.getString("VEHICLE_NO"));
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Recent Deliveries (30 Days)");
    }
