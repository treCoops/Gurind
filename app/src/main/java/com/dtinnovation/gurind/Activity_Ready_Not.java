...
public class Activity_Ready_Not extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.activity_ready_not, container, false);
        flashbar = null;
        ...
        final TableLayout tableLayout = view.findViewById(R.id.tableLayout_RNC);
        ...
        if (netInfo == null){
            ...
            try {
                ...
                String url = "http://220.247.238.246/gurind/mobile_API/ready_not_dispatched.php";
                            ...
                            if(response.getInt("status") == 200){
                                ...
                                for(int i=0; i<jsonArray.length(); i++){
                                    ...
                                    if(i % 2 == 0){
                                        ...
                                        t3.setText(data.getString("QUOTATION_QTY"));
                                        ...
                                        t4.setText(data.getString("PREVIOUS_DISPATCHED"));
                                        ...
                                        t5.setText(data.getString("UNCOLLECTED_QTY"));
                                        ...
                                        t6.setText(data.getString("STOCK_HOLD_DAYS"));
    ...
    public void onViewCreated(View view, @Nullable Bundle savedInstanceState) {
        ...
        getActivity().setTitle("Ready Not Collected");
    }
