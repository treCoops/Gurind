...
public class Activity_Last_Few_Payment extends Fragment {
    ...
    public View onCreateView(final LayoutInflater inflater, @Nullable ViewGroup container, @Nullable Bundle savedInstanceState) {
        ...
        final View view = inflater.inflate(R.layout.activity_last_few_payments, container, false);
        flashbar = null;
        ...
        final TableLayout tableLayout = view.findViewById(R.id.tableLayout_LFP);
        ...
        if (netInfo == null){
            ...
            try {
                ...
                String url = "http://220.247.238.246/gurind/mobile_API/last_receipts.php";
                            ...
                            if(response.getInt("status") == 200){
                                ...
                                for(int i=0; i<jsonArray.length(); i++){
                                    ...
                                    if(i % 2 == 0){
                                        ...
                                        t1.setText(data.getString("receipt_no"));
                                        ...
                                        t2.setText(data.getString("receipt_date"));
                                        ...
                                        t3.setText(convertTOCurrency(data.getString("TOTAL_PAID")));
                                        ...
                                        t4.setText(data.getString("payment_type"));
                                        ...
                                        t5.setText(data.getString("description"));
